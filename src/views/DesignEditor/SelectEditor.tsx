    ...
    <>
      ...
      >
        <Block>
          ...
          <h1 style={{ textAlign: 'center', marginBottom: '2rem' }}>TVC Canva</h1>
          ...
          >
            <Block
              ...
              $style={{
                height: "180px",
                width: "180px",
                background: selectedEditor === "GRAPHIC" ? "#01D28E" : "rgb(231, 236, 239)",
            ...
            <Block
              ...
              $style={{
                height: "180px",
                width: "180px",
                background: selectedEditor === "PRESENTATION" ? "#01D28E" : "rgb(231, 236, 239)",
            ...
            <Block
              ...
              $style={{
                height: "180px",
                width: "180px",
                background: selectedEditor === "VIDEO" ? "#01D28E" : "rgb(231, 236, 239)",
